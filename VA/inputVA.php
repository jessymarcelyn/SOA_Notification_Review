...
<body>
    <div class="container-fluid full-screen">
        <div class="row">
            <div class="content">
                <h2>Enter Virtual Account Number</h2>
                ...
                <form action="" method="post">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button id="submitPin" class="btn btn-primary kirim" type="submit" disabled>Pay</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const bankAccountInput = document.getElementById('VAInput');
